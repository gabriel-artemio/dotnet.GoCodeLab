...
export default function Pacientes(){
  ...
  async function abrirModal(id){
    ...
    const modal = new window.bootstrap.Modal(document.getElementById("modalDetalhes"));
    modal.show();
  }
        ...
        <table className="table table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <button onClick={()=>abrirModal(1)} className="btn btn-warning btn-sm">
                  Detalhes
                </button>
              </td>
            </tr>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p><b>ID:</b>1</p>
                <p><b>Nome:</b> Gabriel Henrique</p>
                <p><b>Nascimento:</b> 27/08/1999</p>
                <p><b>CPF:</b> 111.222.333-44</p>
                <p><b>Endereço:</b> (11) 91234-56789</p>
                <p><b>Telefone:</b> 241528213680001</p>
